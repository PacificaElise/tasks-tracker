...
var Sidebar = function () {
    var _a = globalProvider_1.useGlobalState(), theme = _a.theme, collapsed = _a.collapsed, collapseMenu = _a.collapseMenu;
    ...
    }, firstName = _b.firstName, lastName = _b.lastName, imageUrl = _b.imageUrl;
    var router = navigation_1.useRouter();
    var pathname = navigation_1.usePathname();
    var handleClick = function (link) {
        router.push(link);
    };
    return (react_1["default"].createElement(SidebarStyled, { theme: theme, collapsed: collapsed },
        react_1["default"].createElement("button", { className: 'toggle-nav', onClick: collapseMenu }, collapsed ? icons_1.bars : icons_1.arrowLeft),
...
var SidebarStyled = styled_components_1["default"].nav(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n  width: ", ";\n  background-color: ", ";\n  border: 2px solid ", ";\n  border-radius: 1rem;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n\n  color: ", ";\n\n  @media screen and (max-width: 768px) {\n    position: fixed;\n    height: calc(100vh - 2rem);\n    z-index: 100;\n\n    transition: all 0.3s cubic-bezier(0.53, 0.21, 0, 1);\n    transform: ", ";\n\n    .toggle-nav {\n      display: block !important;\n    }\n  }\n\n  .toggle-nav {\n    display: none;\n    padding: 0.8rem 0.9rem;\n    position: absolute;\n    right: -69px;\n    top: 1.8rem;\n\n    border-top-right-radius: 1rem;\n    border-bottom-right-radius: 1rem;\n\n    background-color: ", ";\n    border-right: 2px solid ", ";\n    border-top: 2px solid ", ";\n    border-bottom: 2px solid ", ";\n  }\n\n  .user-btn {\n    .cl-rootBox {\n      width: 100%;\n      height: 100%;\n\n      .cl-userButtonBox {\n        width: 100%;\n        height: 100%;\n\n        .cl-userButtonTrigger {\n          width: 100%;\n          height: 100%;\n          opacity: 0;\n        }\n      }\n    }\n  }\n\n  .profile {\n    margin: 1.5rem;\n    padding: 1rem 0.8rem;\n    position: relative;\n\n    border-radius: 1rem;\n    cursor: pointer;\n\n    font-weight: 500;\n    color: ", ";\n\n    display: flex;\n    align-items: center;\n\n    .profile-overlay {\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      backdrop-filter: blur(10px);\n      z-index: 0;\n      background: ", ";\n      transition: all 0.55s linear;\n      border-radius: 1rem;\n      border: 2px solid ", ";\n\n      opacity: 0.2;\n    }\n\n    h1 {\n      font-size: 1.2rem;\n      display: flex;\n      flex-direction: column;\n\n      line-height: 1.4rem;\n    }\n\n    .image,\n    h1 {\n      position: relative;\n      z-index: 1;\n    }\n\n    .image {\n      flex-shrink: 0;\n      display: inline-block;\n      overflow: hidden;\n      transition: all 0.5s ease;\n      border-radius: 100%;\n\n      width: 70px;\n      height: 70px;\n\n      img {\n        border-radius: 100%;\n        transition: all 0.5s ease;\n      }\n    }\n\n    > h1 {\n      margin-left: 0.8rem;\n      font-size: clamp(1.2rem, 4vw, 1.4rem);\n      line-height: 100%;\n    }\n\n    &:hover {\n      .profile-overlay {\n        opacity: 1;\n        border: 2px solid ", ";\n      }\n\n      img {\n        transform: scale(1.1);\n      }\n    }\n  }\n\n  .nav-item {\n    position: relative;\n    padding: 0.8rem 1rem 0.9rem 2.1rem;\n    margin: 0.3rem 0;\n\n    display: grid;\n    grid-template-columns: 40px 1fr;\n    cursor: pointer;\n    align-items: center;\n\n    &::after {\n      position: absolute;\n      content: \"\";\n      left: 0;\n      top: 0;\n      width: 0;\n      height: 100%;\n      background-color: ", ";\n      z-index: 1;\n      transition: all 0.3s ease-in-out;\n    }\n\n    &::before {\n      position: absolute;\n      content: \"\";\n      right: 0;\n      top: 0;\n      width: 0%;\n      height: 100%;\n      background-color: ", ";\n\n      border-bottom-left-radius: 5px;\n      border-top-left-radius: 5px;\n    }\n\n    a {\n      font-weight: 500;\n      transition: all 0.3s ease-in-out;\n      z-index: 2;\n      line-height: 0;\n    }\n\n    i {\n      display: flex;\n      align-items: center;\n      color: ", ";\n    }\n\n    &:hover {\n      &::after {\n        width: 100%;\n      }\n    }\n  }\n\n  .active {\n    background-color: ", ";\n\n    i,\n    a {\n      color: ", ";\n    }\n  }\n\n  .active::before {\n    width: 0.3rem;\n  }\n\n  > button {\n    margin: 1.5rem;\n"], ["\n  position: relative;\n  width: ", ";\n  background-color: ", ";\n  border: 2px solid ", ";\n  border-radius: 1rem;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n\n  color: ", ";\n\n  @media screen and (max-width: 768px) {\n    position: fixed;\n    height: calc(100vh - 2rem);\n    z-index: 100;\n\n    transition: all 0.3s cubic-bezier(0.53, 0.21, 0, 1);\n    transform: ",
    ";\n\n    .toggle-nav {\n      display: block !important;\n    }\n  }\n\n  .toggle-nav {\n    display: none;\n    padding: 0.8rem 0.9rem;\n    position: absolute;\n    right: -69px;\n    top: 1.8rem;\n\n    border-top-right-radius: 1rem;\n    border-bottom-right-radius: 1rem;\n\n    background-color: ", ";\n    border-right: 2px solid ", ";\n    border-top: 2px solid ", ";\n    border-bottom: 2px solid ", ";\n  }\n\n  .user-btn {\n    .cl-rootBox {\n      width: 100%;\n      height: 100%;\n\n      .cl-userButtonBox {\n        width: 100%;\n        height: 100%;\n\n        .cl-userButtonTrigger {\n          width: 100%;\n          height: 100%;\n          opacity: 0;\n        }\n      }\n    }\n  }\n\n  .profile {\n    margin: 1.5rem;\n    padding: 1rem 0.8rem;\n    position: relative;\n\n    border-radius: 1rem;\n    cursor: pointer;\n\n    font-weight: 500;\n    color: ", ";\n\n    display: flex;\n    align-items: center;\n\n    .profile-overlay {\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      backdrop-filter: blur(10px);\n      z-index: 0;\n      background: ", ";\n      transition: all 0.55s linear;\n      border-radius: 1rem;\n      border: 2px solid ", ";\n\n      opacity: 0.2;\n    }\n\n    h1 {\n      font-size: 1.2rem;\n      display: flex;\n      flex-direction: column;\n\n      line-height: 1.4rem;\n    }\n\n    .image,\n    h1 {\n      position: relative;\n      z-index: 1;\n    }\n\n    .image {\n      flex-shrink: 0;\n      display: inline-block;\n      overflow: hidden;\n      transition: all 0.5s ease;\n      border-radius: 100%;\n\n      width: 70px;\n      height: 70px;\n\n      img {\n        border-radius: 100%;\n        transition: all 0.5s ease;\n      }\n    }\n\n    > h1 {\n      margin-left: 0.8rem;\n      font-size: clamp(1.2rem, 4vw, 1.4rem);\n      line-height: 100%;\n    }\n\n    &:hover {\n      .profile-overlay {\n        opacity: 1;\n        border: 2px solid ", ";\n      }\n\n      img {\n        transform: scale(1.1);\n      }\n    }\n  }\n\n  .nav-item {\n    position: relative;\n    padding: 0.8rem 1rem 0.9rem 2.1rem;\n    margin: 0.3rem 0;\n\n    display: grid;\n    grid-template-columns: 40px 1fr;\n    cursor: pointer;\n    align-items: center;\n\n    &::after {\n      position: absolute;\n      content: \"\";\n      left: 0;\n      top: 0;\n      width: 0;\n      height: 100%;\n      background-color: ", ";\n      z-index: 1;\n      transition: all 0.3s ease-in-out;\n    }\n\n    &::before {\n      position: absolute;\n      content: \"\";\n      right: 0;\n      top: 0;\n      width: 0%;\n      height: 100%;\n      background-color: ", ";\n\n      border-bottom-left-radius: 5px;\n      border-top-left-radius: 5px;\n    }\n\n    a {\n      font-weight: 500;\n      transition: all 0.3s ease-in-out;\n      z-index: 2;\n      line-height: 0;\n    }\n\n    i {\n      display: flex;\n      align-items: center;\n      color: ", ";\n    }\n\n    &:hover {\n      &::after {\n        width: 100%;\n      }\n    }\n  }\n\n  .active {\n    background-color: ", ";\n\n    i,\n    a {\n      color: ", ";\n    }\n  }\n\n  .active::before {\n    width: 0.3rem;\n  }\n\n  > button {\n    margin: 1.5rem;\n"])), function (props) { return props.theme.sidebarWidth; }, function (props) { return props.theme.colorBg2; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.colorGrey3; }, function (props) {
    return props.collapsed ? 'translateX(-107%)' : 'translateX(0)';
}, function (props) { return props.theme.colorBg2; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.colorGrey0; }, function (props) { return props.theme.colorBg3; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.borderColor2; }, function (props) { return props.theme.activeNavLinkHover; }, function (props) { return props.theme.colorGreenDark; }, function (props) { return props.theme.colorIcons; }, function (props) { return props.theme.activeNavLink; }, function (props) { return props.theme.colorIcons2; });
